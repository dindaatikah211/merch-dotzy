...
export const products: Product[] = [
    ...
    specs: [
      "Isi: Stiker Dot / Zy + Pin Set Dotzy + Gantungan Kunci Dot / Zy + Totebag Canvas ",
      "Stiker: Vinyl waterproof",
      "Pin: Pin plastik",
      "Gantungan Kunci: Acrylic, ±4-6 cm",
  ...
  },
  {
    ...
    longDescription:
      "Paket bundle berisi Totebag Canvas Dotzy dan Stiker Dot / Zy. Paket yang pas buat tampil beda!",
    specs: [
  ...
  },
  {
    ...
    category: "bundle",
    price: 35000,
    description: "Bundle hemat product Dotzy yang berisi Stiker Dot / Zy + Pin Set Dotzy + Gantungan Kunci Dot / Zy.",
    longDescription:
      "Paket bundle berisi Stiker Dot / Zy, Pin Set Dotzy, dan Gantungan Kunci Dot / Zy. Tiga item sekaligus buat kamu yang mau koleksi product Dotzy favoritmu. Harga spesial, kualitas tetap oke!",
    specs: [
      "Isi: Stiker Dot / Zy + Pin Set Dotzy + Gantungan Kunci Dot / Zy",
      "Stiker: Vinyl waterproof",
      "Pin: Pin plastik",
      "Gantungan Kunci: Acrylic, ±4-6 cm",
    ],
  ...
  },
  {
    ...
    category: "bundle",
    price: 28000,
    description: "Bundle hemat product Dotzy yang berisi Pin Set Dotzy + Gantungan Kunci Dot / Zy.",
    longDescription:
      "Paket bundle hemat berisi Pin Set Dotzy dan Gantungan Kunci Dot / Zy — dua item favorit dalam satu paket. Cocok buat kamu yang mau tampil cute tanpa harus beli satuan. Lebih hemat, lebih seru!",
    specs: [
      "Isi: Pin Set Dotzy + Gantungan Kunci Dot / Zy",
      "Pin: Pin plastik",
      "Gantungan Kunci: Acrylic, ±4-6 cm",
    ],
    color: "#f14a1d",
  ...
  },
  {
    ...
    specs: [
      ...
      "Terdapat resleting",
      "Tali panjang",
      "Desain karakter Dotzy cute & playful",
  ...
  },
  {
    ...
    longDescription:
      "Gantungan kunci acrylic dengan desain eksklusif karakter Dotzy. Tersedia pilihan karakter Dot (cloud bear) dan Zy (cloud bunny).",
    specs: [
      "Bahan: Acrylic",
      "Ukuran: ±4-6 cm",
      "Desain karakter Dotzy cute & playful",
  ...
  },
  {
    ...
    longDescription:
      "Dapatkan stiker pack Dotzy! Tahan air dan sinar UV, cocok untuk laptop, tumbler, notebook, atau mana saja yang kamu mau.",
    specs: [
