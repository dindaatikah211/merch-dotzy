...
export const products: Product[] = [
  ...
  },
  {
    ...
    longDescription:
      "Gantungan kunci acrylic dua sisi dengan desain eksklusif Dotzy. Material acrylic tebal 3mm, transparan dan jernih. Dilengkapi ring logam anti karat. Pas buat kunci, tas, atau ransel kamu!",
    specs: [
  ...
  },
  {
    ...
    longDescription:
      "Set 3 buah pin button dengan desain cute & playful dari Dotzy. Terbuat dari metal dengan kaca depan glossy. Ukuran standar 44mm pas banget ditempel di jaket jeans, tas, atau topi kamu.",
    specs: [
  ...
  },
  {
    ...
    category: "totebag",
    price: 65000,
    description: "Totebag canvas tebal dengan desain eksklusif Dotzy.",
    longDescription:
      "Totebag canvas premium 12oz dengan sablon desain eksklusif Dotzy. Kuat menampung buku, laptop tipis, atau belanjaan harian. Tali panjang yang nyaman di bahu. Cocok untuk kuliah, hangout, atau kegiatan sehari-hari.",
    specs: [
      "Bahan: Canvas 12oz",
      "Ukuran: 38x42 cm",
      "Tali panjang: 65 cm",
